...
func AddMoney(
	...
	account1, err = q.AddAccountBalance(ctx, amount1, accountID1)
	if err != nil {
		return
	}

	account2, err = q.AddAccountBalance(ctx, amount2, accountID2)
	return
}
